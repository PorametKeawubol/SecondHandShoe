          ...
          <div className="md:flex">
            <div className="relative">
              <div className="p-4 mb-6">
                ...
                {displayText && (
                  <p className="text-gray-700">Please select images</p>
                )}
                <button
                    ...
                    <div className="absolute z-50 left-1/2 top-24 transform -translate-x-1/2 px-8 w-full">
                      <div className="bg-white w-full max-w-2xl rounded-xl mx-auto py-12 px-6 md:px-12">
                        ...
                        <p className="text-center text-rhino-300 text-sm lg:text-lg max-w-md mx-auto">
                          แอดมินกำลังตรวจสอบสลิปการโอนเงิน ใช้ระยะเวลาประมาณ 2-3
                          ชั่วโมง
                        </p>
                        <p className="text-center mb-8 text-rhino-300 text-sm lg:text-lg max-w-md mx-auto">
                          หากมีข้อสงสัย ติดต่อได้ที่ 08-88888
                        </p>
                        <div className="flex justify-center">
                          <Link
                            onClick={() => {
            ...
            <div className=" drop-shadow-2xl bg-gradient-to-r from-[#355C7D] via-[#6C5B7B] to-[#C06C84] p-6 rounded-3xl text-slate-100">
              <div className="flex">
                ...
                <div className="pt-1 pb-8">
                  ...
                  <p className="">เปิดแอปพลิเคชันธนาคารบนอุปกรณ์ของท่าน</p>
                </div>
              </div>
              <div className="flex">
                <div className="flex flex-col items-center mr-4">
              ...
              <div className="flex">
                ...
                <div className="pt-1 pb-8">
                  ...
                  <p className="">
                    ...
                    โดยกรุณาเช็คชื่อบัญชีผู้รับคือ "บริษัท SECONDHANDSHOE
                    CO.,LTD"
                  </p>
                </div>
              </div>

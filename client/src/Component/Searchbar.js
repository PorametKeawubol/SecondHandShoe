  ...
  const handleSearch = () => {
    ...
    const shoesFiltered = shoes.filter((item) => {
      if (brand === "all" && color === "all" && gender === "all") {
        ...
        return item.genderType === gender && item.status === false;
      } else if (brand !== "all" && color === "all" && gender === "all") {
        return item.brandType === brand && item.status === false;
      } else if (brand === "all" && color !== "all" && gender === "all") {
        return item.colorType === color && item.status === false;
      } else {
        return (
          item.brandType === brand &&
          item.colorType === color &&
            ...
            >
              <li>
                <div className="flex flex-row">
                  ...
                  >
                    <div className="mr-10 w-11">brand</div>
                    <h className="text-slate-400">{brand}</h>
                  </button>
                  <div
                    id="dropdownBrand"
                    className={`z-30 ${
                      isDropdownOpenBrand ? "" : "hidden"
              ...
              <li>
                <div className="flex flex-row">
                  <button
                    ...
                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  >
                    <div className="mr-10 w-11">color</div>
                    <h className="text-slate-400">{color}</h>
                  </button>
                  <div
                    id="dropdownColor"
                    className={`z-30 ${
                      isDropdownOpenColor ? "" : "hidden"
                    } absolute bg-white divide-y divide-gray-100 rounded-lg drop-shadow-lg ml-44 w-44 border-none dark:bg-gray-700`}
                  >
                    <ul
                      class="py-2 text-sm text-gray-700 dark:text-gray-200"
              ...
              <li>
                <div className="flex flex-row">
                  <button
                    ...
                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  >
                    <div className="mr-10 w-11">gender</div>
                    <h className="text-slate-400">{gender}</h>
                  </button>
                  <div
                    id="dropdownBrand"
                    className={`z-30 ${
                      isDropdownOpenGender ? "" : "hidden"
                    } absolute bg-white divide-y divide-gray-100 rounded-lg drop-shadow-lg ml-44 w-44 border-none dark:bg-gray-700`}
                  >
                    <ul
                      class="py-2 text-sm text-gray-700 dark:text-gray-200"

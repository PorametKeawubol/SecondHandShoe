     ...
     return (
          <footer className="footer p-8 mt-16 text-slate-100 bg-gradient-to-r from-[#355C7D] via-[#6C5B7B] to-[#C06C84]">
               <aside className="mb-4  flex items-center items-start">
                    ...
                    <div className="ml-8">
                         <p>We want you to have a good experience with us</p>
                         <p>Sending major good vibes your way</p>
                    </div>
               </aside>
               <nav>
                    ...
                    <div className="grid sm:gridcols-1 md:grid-cols-3 gap-4 mt-4">
                         <a className="flex flex-row ml-10">
                              ...
                              <p className="ml-4">(Twitter) : SecondhandShoe</p>
                         </a>
                         ...
                         <a className="flex flex-row ml-10 ">
                              ...
                              <p className="ml-4">Facebook : SecondhandShoe</p>
                         </a>
                    </div>
               </nav>
               <div class="w-full p-4 text-center mt-6">
                    © SecondhandShoe we here for you
                    <a
